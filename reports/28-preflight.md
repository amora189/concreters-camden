...
```text
  ...
  7. uniqueness gates                            FAIL    5-grams on >2 pages=446; within-class pairs over 40% overlap=1395
  ...
  12. coherence gate (D15)                       FAIL    11 pages SEVERE, 56 above threshold, corpus filler 0.6108 — no page above the threshold may enter any wave
  ...
  16. claim-to-evidence parity                   PASS    occurrences=16; unsupported=0; pages=6; unsupported-pages=0
